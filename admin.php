...
?>
		...
		Titre : <input type='text' name='titre' value="<?php if(isset($news)) echo $news->titre();?>"/>
		<br>
		<?php if(isset($erreurs) && in_array(News::CONTENU_INVALIDE, $erreurs)) echo 'Le contenu est invalide.<br>';?>
		Contenu : <br><textarea rows="8" cols="60" name="contenu"><?php if(isset($news)) echo $news->contenu() ;?></textarea>
		<br>
		<?php
